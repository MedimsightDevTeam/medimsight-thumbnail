# medimsight-thumbnail using LitElement JavaScript starter 

This project includes a sample medimsight-thumbnail component using LitElement with JavaScript. For more infomation a funny stuff visit [Medimsight](https://www.medimsight.com) or contact us.
